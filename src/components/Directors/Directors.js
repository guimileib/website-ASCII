...
export default function Diretores() {
    ...
    const handleLeftClick = (event) => {
        ...
        carousel.current.scrollLeft -= (carousel.current.offsetWidth * carouselItem.current.width);
    ...
    return (
        <div className="diretores">
            ...
            <p> Contamos com um time dedicado e diverso, conheça mais sobre nossos membros: </p>
